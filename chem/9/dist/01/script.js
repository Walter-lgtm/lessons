// script.js - Часть 1: Данные заданий (ИСПРАВЛЕННЫЕ И БЕЗ ПОДСКАЗОК)
const quizData = [
  {
    id: 1,
    title: "Задание 1. Classification по числу и составу веществ",
    formulas: [
  ...
  },
  {
    ...
    formulas: [
      ...
      "Г) CuO + 2HNO<sub>3</sub> = Cu(NO<sub>3</sub>)2 + H<sub>2</sub>O"
    ],
    types: [
      "1) ОВР (межмолекулярная)",
      "2) ОВР (внутримолекулярная)",
      "3) Не ОВР (обменная)",
      "4) Не ОВР (без изменения С.О.)"
    ],
    correctAnswer: "2314",
    explanations: {
  ...
  },
  {
    ...
    types: [
      "1) Экзотермическая (горение сложного вещества)",
      "2) Эндотермическая (соединение)",
      "3) Экзотермическая (горение простого вещества)",
      "4) Эндотермическая (разложение)"
    ],
    correctAnswer: "1234",
    explanations: {
      "А": "Горение метана (сложного вещества) происходит с выделением тепла (+Q) — экзотермическая реакция (1).",
      "Б": "Взаимодействие азота с кислородом — эндотермическое горение (-Q), редкое исключение для реакций соединения (2).",
      "В": "Горение угля (простого вещества) идет с выделением тепла (+Q) — экзотермическая реакция (3).",
      "Г": "Разложение известняка (соли) требует постоянного нагревания, тепло поглощается (-Q) — эндотермическая реакция (4)."
    }
  },
  {
    id: 4,
    ...
    formulas: [
      ...
      "В) SO<sub>2</sub> + O<sub>2</sub> ⇄ SO<sub>3</sub>",
    ...
    correctAnswer: "1212", // А-1, Б-2, В-1, Г-2
    explanations: {
      "А": "Синтез аммиака — классический пример обратимой реакции, о чем также говорит знак (⇄) (1).",
      "Б": "Гремучий газ реагирует бурно и до конца, реакция необратима (2).",
      "В": "Окисление диоксида серы на катализаторе протекает в обоих направлениях — реакция обратимая (1).",
      "Г": "Реакция ионного обмена идет до конца (необратима) из-за выпадения нерастворимого осадка BaSO<sub>4</sub> (2)."
    }
  },
  {
    id: 5,
    ...
    explanations: {
      ...
      "Б": "Реагируют твердый известняк и жидкий раствор кислоты, есть явная граница раздела сред — реакция гетерогенная (2).",
      "В": "Исходные вещества находятся в одной фазе (газы) — реакция гомогенная (1).",
      "Г": "Железо — твердое вещество, а сульфат меди — в растворе. Реакция идет на поверхности металла — гетерогенная (2)."
    }
  }
];
