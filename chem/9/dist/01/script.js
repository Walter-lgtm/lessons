...
const quizData = [
  ...
  },
  {
    ...
    correctAnswer: "1234", // Из-за повторяющихся названий типов, порядок сопоставления: А-1, Б-2, В-3, Г-4 согласно теории
    explanations: {
      "А": "Горение метана происходит с выделением тепла (+Q) — экзотермическая реакция (1).",
      "Б": "Взаимодействие азота с кислородом — эндотермическое горение (-Q), важное исключение (2).",
