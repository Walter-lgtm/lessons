...
const quizData = [
  ...
  },
  {
    ...
    types: [
      ...
      "2) Эндотермическая (соединение газов)",
      "3) Экзотермическая (горение простого вещества)",
      "4) Эндотермическая (разложение соли)"
    ],
    correctAnswer: "1234",
    explanations: {
  ...
  },
  {
    ...
    explanations: {
      ...
      "В": "Окисление SO<sub>2</sub> в SO<sub>3</sub> является обратимым процессом (3).",
      "Г": "Реакция обмена идет до конца (необратима), так как образуется осадок BaSO<sub>4</sub> (4)."
    }
  },
  {
    id: 5,
    ...
    explanations: {
      ...
      "Г": "Железо — твердое вещество, а сульфат меди — в растворе, реакция идет на поверхности раздела фаз — гетерогенная (4)."
    }
  }
];
