const questions = [
  ...
  {
    type: "matching",
    text: "Сопоставь термины и определения:",
    pairs: [
      { term: "Фотосинтез", definition: "Процесс образования органических веществ из неорганических с использованием энергии света" },
      { term: "Дыхание", definition: "Процесс расщепления органических веществ с выделением энергии" },
      { term: "Питание", definition: "Поступление в организм веществ, необходимых для роста и жизнедеятельности" }
    ],
    // порядок индексов правильных пар: [0,1,2] — то есть 1-1, 2-2, 3-3
  ...
  },
  {
    ...
    statements: [
      "Все живые организмы способны к фотосинтезу.",
      "Рост — это увеличение размеров и массы организма.",
      "Размножение есть только у животных."
    ],
  ...
  {
    type: "image-label",
    text: "Рассмотри рисунок и подпиши части клетки (перетащи подписи к нужным местам):",
    imageUrl: "https://via.placeholder.com/400x250/f0f0f0/333?text=Схема+клетки", // сюда подставишь реальную картинку
    labels: ["Ядро", "Цитоплазма", "Клеточная мембрана"],
    // правильные индексы для каждой подписи (в порядке labels)
    correctAnswers: [0, 1, 2], // пока просто заглушка: логика будет по координатам
    points: 3,
    labelPositions: [
      { x: 120, y: 80 }, // Ядро
      { x: 220, y: 140 }, // Цитоплазма
      { x: 300, y: 200 }  // Мембрана
    ]
  }
];
