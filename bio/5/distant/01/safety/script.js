...
const safetyRules = [
    ...
    },
    {
        ...
        text: "Предметные и покровные стекла для микроскопа тоньше, чем лед в Йотунхейме. Нажимай на них аккуратно. Если стекло треснуло, не трогай осколки руками! Громко зови учителя — это его магия убирать стекло.",
    ...
    },
    {
        ...
        text: "После того как ты изучил лапку мухи или кожицу лука, наведи порядок! Выключи микроскоп, сдай стёкла и вымой руки с мылом. Биологи любят чистоту, ведь грязь порождает злых монстров (и плохие оценки).",
...
const thorQuotes = [
    ...
    "Ква-ква! (Перевод: Слушайте учителя биологии, ребята, иначе будете ловить мух вместе со мной.)"
];
/* ==========================================================================
...
document.addEventListener("DOMContentLoaded", () => {
            ...
            card.addEventListener("click", () => {
                ...
                switch(ruleId) {
                    case 1:
                        ...
                        break;
                    case 2:
                        lokiBubble.innerText = "⚔️ Острыми предметами махать вздумал? Помни, настоящий учёный побеждает умом, а не глупым размахиванием скальпелем!";
                        break;
                    case 3:
                        ...
                        break;
                    case 4:
                        lokiBubble.innerText = "🧪 Нюхать жидкости в упор — это для глупых великанов. Будь хитрее, подманивай запах ладонью, как я учил!";
                        break;
                    case 5:
    ...
    function makeThorCroak() {
        ...
        lokiBubble.innerText = "😏 Слышал? Вот так звучит полное нарушение Кодекса правил техники безопасности!";
    }
