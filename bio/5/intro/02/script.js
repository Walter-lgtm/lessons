document.addEventListener("DOMContentLoaded", () => {
    ...
    // ==========================================
    // 1. АВТОРИЗАЦИЯ И СТАРТ ТЕСТА (без токена)
    // ==========================================
    startBtn.addEventListener("click", () => {
        ...
        if (!studentName || !studentClass) {
            alert("Пожалуйста, заполните поля «Фамилия и имя» и «Класс».");
            return;
        }
    ...
    function initDragAndDrop() {
        ...
        gaps.forEach(gap => {
            ...
            gap.addEventListener("drop", (e) => {
                ...
                // Если в пропуске уже было слово, возвращаем его обратно в общий контейнер
                if (gap.textContent !== "") {
    ...
    // ==========================================
    // 5. ПЕРЕДАЧА ДАННЫХ В GOOGLE ТАБЛИЦУ
    // ==========================================
